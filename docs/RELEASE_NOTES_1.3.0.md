...
- **Default window size / fullscreen feel:** the app now opens maximized with a 1920x1080 (1080p) target size (clamped to your display work area) so it fills the screen on standard 1080p desktops.
