    ...
    "args0": [
      ...
      },
      {
        ...
        "options": [
          ...
          ["OnAIMoveToRunning", "ON_AI_MOVE_TO_RUNNING"],
          ["OnAIMoveToSucceeded", "ON_AI_MOVE_TO_SUCCEEDED"],
          ["OnAIParachuteRunning", "ON_AI_PARACHUTE_RUNNING"],
          ["OnAIParachuteSucceeded", "ON_AI_PARACHUTE_SUCCEEDED"],
          ["OnAIWaypointIdleFailed", "ON_AI_WAYPOINT_IDLE_FAILED"],
          ["OnAIWaypointIdleRunning", "ON_AI_WAYPOINT_IDLE_RUNNING"],
          ["OnAIWaypointIdleSucceeded", "ON_AI_WAYPOINT_IDLE_SUCCEEDED"],
          ["OnCapturePointCaptured", "ON_CAPTURE_POINT_CAPTURED"],
          ["OnCapturePointCapturing", "ON_CAPTURE_POINT_CAPTURING"],
          ["OnCapturePointLost", "ON_CAPTURE_POINT_LOST"],
          ["OnGameModeEnding", "ON_GAME_MODE_ENDING"],
          ["OnGameModeStarted", "ON_GAME_MODE_STARTED"],
          ["OnMandown", "ON_MANDOWN"],
          ["OnMCOMArmed", "ON_MCOM_ARMED"],
          ["OnMCOMDefused", "ON_MCOM_DEFUSED"],
          ["OnMCOMDestroyed", "ON_MCOM_DESTROYED"],
          ["OnPlayerDamaged", "ON_PLAYER_DAMAGED"],
          ["OnPlayerDeployed", "ON_PLAYER_DEPLOYED"],
          ["OnPlayerDied", "ON_PLAYER_DIED"],
          ["OnPlayerEarnedKill", "ON_PLAYER_EARNED_KILL"],
          ["OnPlayerEarnedKillAssist", "ON_PLAYER_EARNED_KILL_ASSIST"],
          ["OnPlayerEnterAreaTrigger", "ON_PLAYER_ENTER_AREA_TRIGGER"],
          ["OnPlayerEnterCapturePoint", "ON_PLAYER_ENTER_CAPTURE_POINT"],
          ["OnPlayerEnterVehicle", "ON_PLAYER_ENTER_VEHICLE"],
          ["OnPlayerEnterVehicleSeat", "ON_PLAYER_ENTER_VEHICLE_SEAT"],
          ["OnPlayerExitAreaTrigger", "ON_PLAYER_EXIT_AREA_TRIGGER"],
          ["OnPlayerExitCapturePoint", "ON_PLAYER_EXIT_CAPTURE_POINT"],
          ["OnPlayerExitVehicle", "ON_PLAYER_EXIT_VEHICLE"],
          ["OnPlayerExitVehicleSeat", "ON_PLAYER_EXIT_VEHICLE_SEAT"],
          ["OnPlayerInteract", "ON_PLAYER_INTERACT"],
          ["OnPlayerJoinGame", "ON_PLAYER_JOIN_GAME"],
          ["OnPlayerLeaveGame", "ON_PLAYER_LEAVE_GAME"],
          ["OnPlayerSwitchTeam", "ON_PLAYER_SWITCH_TEAM"],
          ["OnPlayerUIButtonEvent", "ON_PLAYER_UI_BUTTON_EVENT"],
          ["OnPlayerUndeploy", "ON_PLAYER_UNDEPLOY"],
          ["OnRayCastHit", "ON_RAY_CAST_HIT"],
          ["OnRayCastMissed", "ON_RAY_CAST_MISSED"],
          ["OnRevived", "ON_REVIVED"],
          ["OnRingOfFireZoneSizeChange", "ON_RING_OF_FIRE_ZONE_SIZE_CHANGE"],
          ["OnSpawnerSpawned", "ON_SPAWNER_SPAWNED"],
          ["OnTimeLimitReached", "ON_TIME_LIMIT_REACHED"],
          ["OnVehicleDestroyed", "ON_VEHICLE_DESTROYED"],
          ["OnVehicleSpawned", "ON_VEHICLE_SPAWNED"]
        ]
      },
      {
        "type": "field_dropdown",
        ...
        "options": [
          ...
          ["LootSpawner", "LOOT_SPAWNER"],
          ["MCOM", "MCOM"],
          ["Player", "PLAYER"],
          ["RingOfFire", "RING_OF_FIRE"],
          ["ScreenEffect (deprecated)", "SCREEN_EFFECT"],
          ["Sector", "SECTOR"],
          ["SFX", "SFX"],
